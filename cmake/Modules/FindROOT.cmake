...
SET(MINUIT2_LIB)
FIND_LIBRARY(MINUIT2_LIB NAMES Minuit2 libMinuit2 PATHS ${ROOT_LIBRARY_DIR})
IF(NOT MINUIT2_LIB-NOTFOUND)
  MESSAGE ("-- Found Minuit2")
  SET(ROOT_LIBRARIES ${ROOT_LIBRARIES} "-lMinuit2")
ELSE(NOT MINUIT2_LIB-NOTFOUND)
  MESSAGE("Warning: Minuit2 has not been found.")
  MESSAGE("Warning: The program might not compile.")
ENDIF(NOT MINUIT2_LIB-NOTFOUND)

  SET(ROOT_LIBRARIES ${ROOT_LIBRARIES} ${root_flags})
